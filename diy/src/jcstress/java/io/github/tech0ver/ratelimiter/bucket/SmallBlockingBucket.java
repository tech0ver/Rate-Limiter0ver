...
public abstract class SmallBlockingBucket {

    private final TimeSource ts = () -> 0L;
    private final ThreadParker parker = new ThreadParker() {
    ...
    private final MyRateLimiter limiter = createLimiter(1, Duration.ofMillis(100L), ts, parker);

    protected abstract MyRateLimiter createLimiter(long capacity, Duration interval, TimeSource ts, ThreadParker parker);
